			...
			<table  class="table table-stripper table-hover" id="table">
				...
				<tbody class="title-tbody">
					...
					<tr>
                        ...
                        <td class="center" align="center"><a href="admin/tangni/danhsach/{{$tv->tuvien_id}}"><i class="fa fa-list" style="font-size: 20px; color: blue;"></i></a></td>
						<td align="center" class="noshow">
                                <a  href="admincaptinh/tuvien/chitiet/{{$tv->tuvien_id}}"class="delete-button"><i class="fa fa-info-circle" style="font-size: 18px"></i>
                                </a>
                            </td>
					</tr>
					@endforeach
